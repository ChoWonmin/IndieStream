      ...
      <div class="layout" >
		<c:import url="/view/header.jsp"></c:import>
         ...
         <div class="wrapper" >
            ...
            <!-- Forms-->
            <section class="module module-divider-bottom" style="margin: auto;">
            ...
            <div class="content-box" style="background-color: #fdfdfd; padding: 10px; display: inline-block; width: 100%">   
               ...
               <!-- =================    writer  start  =================== -->
                     <%-- <div class="area">
                        <div class="text">
                           <label class="col-1 col-form-label" for="example-text-input">Artist</label>
                        </div>
                        <div class="inputarea">
                           <input class="form-control" type="text" value="${mvo.memberId}" name="soundWriter" readonly="readonly">
                        </div>
                     </div> --%>
                        ...
                        <div class="image col-4">
                           ...
                           <div class="imageCenter" id="soundImgSpace">
                              <img id="soundImg" name="soundImg"
                                 src="${initParam.root}img/noImage.png">
                           </div>
                           <br>
               ...
               <div style="padding-top: 20px; padding-bottom: 20px; text-align: center;"> 
                  ...
                  <!-- <div class="imageCenter m-b-10 ">
                     <a class="btn btn-round btn-outline btn-brand" type="submit" onclick="return soundRegister()">Upload</a>
                  </div>
                  <br> -->
